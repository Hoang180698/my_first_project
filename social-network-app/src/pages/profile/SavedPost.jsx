        ...
        <div className="container">
          <div className="row">
            <h1>
              ...
              <p className="text-center" style={{fontSize:"16px"}}>Save photos and videos that you want to see again. No one is notified, and only you can see what you've saved.</p>
            </h1>
          </div>
        </div>
      </section>
